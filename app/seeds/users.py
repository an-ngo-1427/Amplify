...
def seed_users():
    ...
    an = User(
        first_name = 'An', last_name = 'Ngo', username='an', email='an@aa.io', password='password')
    dennis = User(
        first_name = 'Dennis', last_name = 'Ma', username='dennis', email='dennis@aa.io', password='password')
    gary = User(
